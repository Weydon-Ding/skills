...
- **Linux/macOS**: Use `validate_mermaid.sh`
- **Windows**: Use `validate_mermaid.ps1`
...
**Windows (PowerShell):**
```powershell
base/skills/mermaid/scripts/validate_mermaid.ps1 /path/to/diagram.mmd
```
...
**Windows (PowerShell):**
```powershell
base/skills/mermaid/scripts/validate_mermaid.ps1 /path/to/document.md
```
...
"flowchart TD
    ...
    MFACheck -->|Yes| Success
    MFACheck -->|No| Error
    Success --> End([Dashboard])" | base/skills/mermaid/scripts/validate_mermaid.ps1
```
...
"stateDiagram-v2
    [*] --> Idle
    Idle -> Running : start
    Running -> Idle : stop" | base/skills/mermaid/scripts/validate_mermaid.ps1
```
...
**Windows (PowerShell):**
- `"diagram" | base/skills/mermaid/scripts/validate_mermaid.ps1` (stdin)
- `base/skills/mermaid/scripts/validate_mermaid.ps1 file.mmd` (single file)
- `base/skills/mermaid/scripts/validate_mermaid.ps1 file.md` (markdown with multiple diagrams)
...
2. ✅ Validation passes with the appropriate script:
   - **Linux/macOS**: `validate_mermaid.sh`
   - **Windows**: `validate_mermaid.ps1`
